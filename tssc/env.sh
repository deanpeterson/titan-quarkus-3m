...
export IMAGE_URL=${IMAGE_URL-quay-quay-quay-test.apps.salamander.aimlworkbench.com/rhdh/titan-quarkus-3m:$CI_TYPE-$TAG}
...
export GITOPS_REPO_URL=https://github.com/deanpeterson/titan-quarkus-3m-gitops
